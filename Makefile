...
SRCS = averager.cpp averager.h baseent.cpp baseent.h baserule.cpp baserule.h buildhtml.cpp buildhtml.h camera.cpp camera.h colorshiftr.cpp colorshiftr.h defines.h descriminatoryr.cpp descriminatoryr.h drules.cpp drules.h env.cpp env.h events.cpp events.h fland.cpp fland.h fmlparser.cpp fmlparser.h fmlutils.cpp fmlutils.h glut.h glutenv.cpp glutenv.h groupr.cpp groupr.h main.cpp main.h meshseed.cpp meshseed.h rendervertex.cpp rendervertex.h roughr.cpp roughr.h templates.h tyler.cpp tyler.h vertex.cpp vertex.h 

OBJS = averager.o baseent.o baserule.o buildhtml.o camera.o colorshiftr.o descriminatoryr.o drules.o env.o events.o fland.o fmlparser.o fmlutils.o glutenv.o groupr.o main.o meshseed.o rendervertex.o roughr.o tyler.o vertex.o 
